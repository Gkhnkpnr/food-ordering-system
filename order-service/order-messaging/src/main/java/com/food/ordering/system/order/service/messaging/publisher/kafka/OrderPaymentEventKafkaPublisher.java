...
public class OrderPaymentEventKafkaPublisher implements PaymentRequestMessagePublisher {
    ...
    public void publish(OrderPaymentOutboxMessage orderPaymentOutboxMessage,
        ...
        log.info("Received OrderPaymentOutboxMessage fir order id : {} and saga id: {}",
                orderPaymentEventPayload.getOrderId(),
                sagaId);

        try {
            PaymentRequestAvroModel paymentRequestAvroModel = orderMessagingDataMapper
                    .orderPaymentEventPayloadToPaymentRequestAvroModel(sagaId, orderPaymentEventPayload);
            ...
            log.error("Error while sending OrderPaymentEventPayload to kafka with order idL {} and saga id: {}, error : {}",
