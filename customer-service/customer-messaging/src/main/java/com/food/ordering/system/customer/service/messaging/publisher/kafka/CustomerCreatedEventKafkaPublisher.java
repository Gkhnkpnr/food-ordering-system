...
public class CustomerCreatedEventKafkaPublisher implements CustomerMessagePublisher {
    ...
    getCallback(String topicName, CustomerAvroModel customerAvroModel) {
        return new  ListenableFutureCallback<>() {
            ...
            public void onFailure(Throwable throwable) {
                log.error("Error while sending message {} to topic {}", customerAvroModel.toString(), topicName, throwable);
            }
        };
    }
}
