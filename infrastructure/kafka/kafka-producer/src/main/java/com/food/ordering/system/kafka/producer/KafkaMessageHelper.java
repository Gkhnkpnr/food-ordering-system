    ...
    getKafkaCallback(String responseTopicName, T avroModel, U outboxMessage,
        ...
        return new ListenableFutureCallback<SendResult<String, T>>() {
            ...
            public void onFailure(Throwable ex) {
                log.error("Error while sending {} with message {} and OutboxType {} to topic {}",
            ...
            public void onSuccess(SendResult<String, T> result) {
                ...
                log.info("Received succesful response from Kafka for order id: {}" + " Topic: {} Partition: {} Offset: {} Timestamp: {}",
                        orderId,
                        metadata.topic(),
                        metadata.partition(),
                        metadata.offset(),
